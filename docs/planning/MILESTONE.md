...
- [ ] Every feature row covered by this milestone ticked in features.md with tests and docs
- [ ] All tests passing

## Phases

1. Phase 1.1 — Chunking Strategies [pending]
2. Phase 1.2 — Retrieval Techniques [pending]
