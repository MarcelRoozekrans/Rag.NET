...
| 5.2.1 | The GraphRAG Deficit Read Back | #232 (decompose the −0.043) — **measured**; #174 (cold wall clock, twice); #226 (parallel reports) | **in progress** — added 2026-08-15 so the milestone finishes whole. #232 answered the same day: depth costs **0.00000** (the depth control reproduces the Real leg to five decimals), so the −0.04309 is store pollution entire; #174 and #226 open |
