...
| Raptor | `ragnet.raptor.build` | `document.id`, `raptor.tree.depth`, `raptor.summary.count` | `ragnet.ingest` |
| Raptor | `ragnet.raptor.summarize` | `raptor.tree.level`, `raptor.chunk.count`, `raptor.cluster.count` | `ragnet.raptor.build` (once per level) |
