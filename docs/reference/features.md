...
- **65% of the slice's communities hold one entity** (396 of 607), of which 273 are entities appearing in no relationship at all. Leiden emitting one community per unattachable node is correct behaviour; it is recorded because the extraction quality underneath it is not something this guard measures.
