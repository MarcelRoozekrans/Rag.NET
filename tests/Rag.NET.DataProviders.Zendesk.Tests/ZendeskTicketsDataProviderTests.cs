...
public sealed class ZendeskTicketsDataProviderTests
{
    ...
    public async Task GetFilesAsync_Metadata_PinsTicketKeys()
    {
        ...
        // GetFilesAsync_UpdatedAt_IsTypedAndSurfacesAsUpdatedAtChunkTag below.
    ...
    /// <summary>
    /// Phase 4.10 Task 4: <c>updated_at</c> used to be written as a plain
    ...
    /// </summary>
    [Fact]
    public async Task GetFilesAsync_UpdatedAt_IsTypedAndSurfacesAsUpdatedAtChunkTag()
    {
        const string ticketsJson = """
            {
              "tickets": [
                { "id": 9001, "subject": "Timestamp ticket", "description": "x", "status": "open", "priority": "low", "updated_at": "2026-03-01T10:00:00Z" }
              ],
              "after_cursor": null,
              "end_of_stream": true,
              "end_time": 1735700000
